package com.library.base.view.clipImage;
 ...
 * @author zhy
 */
public class ClipZoomImageView extends ImageView implements OnScaleGestureListener,
...

{
    ...
    private class AutoScaleRunnable implements Runnable {
        ...
        public void run() {
            // 进行缩放
            postScale(tmpScale, tmpScale, x, y);
            checkBorder();
            ...
            // 设置为目标的缩放比例
            {
                ...
                postScale(deltaScale, deltaScale, x, y);
                checkBorder();
                setImageMatrix(mScaleMatrix);
                isAutoScale = false;
            }
    ...
    public Bitmap clip() {
        ...
        draw(canvas);
        return Bitmap.createBitmap(bitmap, mHorizontalPadding, mVerticalPadding, getWidth() - 2
    ...
    /**
     * @param @param isCanScale 设定文件
     * @return void 返回类型
     * @throws
     * @Title: setCanScale
     * @Description: 设置是否可以缩放
     */
     ...
     * @throws
     * @Title: postScale
     * @Description: 根据isCanScale来判断是否可以缩放
     */
